...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicG9seWhpc3RvciIsImEiOiJja2I5Mmp0djcwYTM4MnJ1Zmlocjd4Z2x5In0.6_JCPSvezA9AqT-HANHz8Q';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "".concat(type, " updated succesfully"));
            }
...
var stripe = Stripe('pk_test_6hdy9n7Gzn1dOukWsM9MTTwB00g57LkBi6');
